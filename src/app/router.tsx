...
const PartnerProduct = lazy(
  () => import('@/features/parter/pages/detail/PartnerProduct'),
);
const PartnerBuy = lazy(
  () => import('@/features/parter/pages/detail/PartnerBuy'),
);
const PartnerSell = lazy(
  () => import('@/features/parter/pages/detail/PartnerSell'),
);
const PartnerPayments = lazy(
  () => import('@/features/parter/pages/detail/PartnerPayments'),
);
